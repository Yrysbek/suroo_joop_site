...
var VKI_attach, VKI_close;
  function VKI_buildKeyboardInputs() {
    ...
    this.VKI_kt = "Кыргызча";  // Default keyboard layout
    this.VKI_clearPasswords = false;  // Clear password fields on focus
    this.VKI_imageURI = "/public/img/keyboard.png";
    this.VKI_clickless = 0;  // 0 = disabled, > 0 = delay in ms
    this.VKI_keyCenter = 3;

    this.VKI_isIE = /*@cc_on */ false;
    this.VKI_isIE6 = /*if(@_jscript_version == 5.6); */ false;
    ...
    /* ***** i18n text strings ************************************* */
    this.VKI_i18n = {
      '00': "'өүң'ды жазыш үчүн клавиатура",
      '01': "'өүң'ды жазыш үчүн клавиатура",
...
this.VKI_layout["Кыргызча"]= [ // Kyrgyz Keyboard
      [["\u0451", "\u0401"], ["1", "!"], ["2", '"'], ["3", "\u2116"], ["4", ";"], ["5", "%"], ["6", ":"], ["7", "?"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["\u04e9", "\u04e8"], ["Bksp", "Bksp"]],
      [["Tab", "Tab"], ["\u0439", "\u0419"], ["\u0446", "\u0426"], ["\u0443", "\u0423"], ["\u043A", "\u041A"], ["\u0435", "\u0415"], ["\u043D", "\u041D"], ["\u0433", "\u0413"], ["\u0448", "\u0428"], ["\u0449", "\u0429"], ["\u0437", "\u0417"], ["\u0445", "\u0425"], ["\u04af", "\u04ae"], ["\u04a3", "\u04a2"]],
    ...
    this.VKI_layout["Русская"] = [ // Russian Standard Keyboard
      ...
      var tr = document.createElement('tr');
        var th = document.createElement('th');
          var abbr = document.createElement('abbr');
              ...
              abbr.appendChild(document.createTextNode('ӨҮҢ клавиатура'));
            th.appendChild(abbr);
